  ...
  return (
    <div className="w-full text-white text-center text-balance flex flex-col justify-center gap-4">
      ...
      >
        ...
        energy infrastructure to produce a new generation of natural gas,
        electric natural gas (e-NG), with a very low carbon intensity. From the
        heart of the Midwest, the project is building a supply chain designed to
        serve customers around the world such as Japan. There, it will gradually
        substitute for fossil natural gas across existing city-gas networks,
        delivering lower-carbon energy without requiring an entirely new energy
        system.
      </motion.p>
    </div>
  );
